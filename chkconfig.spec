...
%changelog
* Mon Oct 16 2006 Bill Nottingham <notting@redhat.com> 1.3.13.5.EL3-1
- don't error out completely on broken symlinks (#203831)

* Fri Feb 24 2006 Bill Nottingham <notting@redhat.com> 1.3.13.4-0.3
...
* Thu Feb 10 2005 Bill Nottingham <notting@redhat.com> 1.3.13.1-0.3
- fix: prefer chkconfig: priorities if Required-Start/Required-Stop
  aren't set

* Tue Jan 11 2005 Bill Nottingham <notting@redhat.com> 1.3.13-0.3
- fix LSB comment parsing some more (#144739)

* Fri Jun  4 2004 Bill Nottingham <notting@redhat.com> 1.3.11-0.3
