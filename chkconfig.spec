...
%changelog
* Mon Oct 16 2006 Bill Nottingham <notting@redhat.com> 1.3.13.5.EL4-1
- don't error out completely on broken symlinks (#209983)

* Fri Feb 24 2006 Bill Nottingham <notting@redhat.com> 1.3.13.3-3
- fix accidental enabling of LSB services on --add (#182729)

* Wed Nov 30 2005 Bill Nottingham <notting@redhat.com> 1.3.13.3-2
- fix 'chkconfig --level 345 <service> on' for LSB services

* Tue Nov  8 2005 Bill Nottingham <notting@redhat.com> 1.3.13.3-1
...
* Tue Feb 22 2005 Bill Nottingham <notting@redhat.com> 1.3.13.2-1
